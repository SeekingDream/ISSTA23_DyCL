...
def predictAPI_No_OPT(input_dict, model_dict, self, constant_dict):
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    output = model_dict['my_func44'](input_dict)
    return output
...
def ONNX_API_No_OPT(input_dict, model_dict, self, constant_dict):
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output] = model_dict['my_func44'].run(['output::output'], input_dict)
    return output
...
def TVM_API_No_OPT(input_dict, model_dict, params_dict, self, constant_dict):
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    output = model_dict['my_func44'](**params)
    params = params_dict['my_func44']
    input_dict = {}
    input_dict['fwd'] = fwd
    params.update(input_dict)
...
def predictAPI_OPT(input_dict, model_dict, self, constant_dict):
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    (output, fwd) = model_dict['my_func29'](input_dict)
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    (output, fwd) = model_dict['my_func35'](input_dict)
...
def ONNX_API_OPT(input_dict, model_dict, self, constant_dict):
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output, fwd] = model_dict['my_func29'].run(['output::output', 'output::fwd'], input_dict)
    is_output = constant_dict['my_func29::is_output']
    if is_output:
        input_dict = {}
        (input_dict['input::output'], input_dict['input::fwd']) = (output, fwd)
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output, fwd] = model_dict['my_func35'].run(['output::output', 'output::fwd'], input_dict)
    is_output = constant_dict['my_func35::is_output']
    if is_output:
        input_dict = {}
        (input_dict['input::output'], input_dict['input::fwd']) = (output, fwd)
...
def TVM_API_OPT(input_dict, model_dict, params_dict, self, constant_dict):
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    (output, fwd) = model_dict['my_func29'](**params)
    is_output = constant_dict['my_func29::is_output']
    params = params_dict['my_func29']
    input_dict = {}
    input_dict['fwd'] = fwd
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    (output, fwd) = model_dict['my_func35'](**params)
    is_output = constant_dict['my_func35::is_output']
    params = params_dict['my_func35']
    input_dict = {}
    input_dict['fwd'] = fwd
