...
def predictAPI_No_OPT(input_dict, model_dict, self, constant_dict):
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    output = model_dict['my_func41'](input_dict)
    return output
...
def ONNX_API_No_OPT(input_dict, model_dict, self, constant_dict):
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output] = model_dict['my_func41'].run(['output::output'], input_dict)
    return output
...
def TVM_API_No_OPT(input_dict, model_dict, params_dict, self, constant_dict):
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    output = model_dict['my_func41'](**params)
    params = params_dict['my_func41']
    input_dict = {}
    input_dict['fwd'] = fwd
    params.update(input_dict)
...
def predictAPI_OPT(input_dict, model_dict, self, constant_dict):
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    (output, fwd) = model_dict['my_func2'](input_dict)
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    (output, fwd) = model_dict['my_func14'](input_dict)
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    (output, fwd) = model_dict['my_func26'](input_dict)
    ...
    if is_output:
        ...
        if confidence >= self.confidence_threshold:
            ...
            return output
    input_dict['fwd'] = fwd
    fwd = model_dict['my_func32'](input_dict)
    output = constant_dict['my_func32::output']
...
def ONNX_API_OPT(input_dict, model_dict, self, constant_dict):
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output, fwd] = model_dict['my_func2'].run(['output::output', 'output::fwd'], input_dict)
    is_output = constant_dict['my_func2::is_output']
    if is_output:
        input_dict = {}
        (input_dict['input::output'], input_dict['input::fwd']) = (output, fwd)
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output, fwd] = model_dict['my_func14'].run(['output::output', 'output::fwd'], input_dict)
    is_output = constant_dict['my_func14::is_output']
    if is_output:
        input_dict = {}
        (input_dict['input::output'], input_dict['input::fwd']) = (output, fwd)
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [output, fwd] = model_dict['my_func26'].run(['output::output', 'output::fwd'], input_dict)
    is_output = constant_dict['my_func26::is_output']
    if is_output:
        input_dict = {}
        (input_dict['input::output'], input_dict['input::fwd']) = (output, fwd)
    ...
    input_dict = {}
    input_dict['input::fwd'] = fwd
    [fwd] = model_dict['my_func32'].run(['output::fwd'], input_dict)
    output = constant_dict['my_func32::output']
    is_output = constant_dict['my_func32::is_output']
    if is_output:
        input_dict = {}
...
def TVM_API_OPT(input_dict, model_dict, params_dict, self, constant_dict):
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    (output, fwd) = model_dict['my_func2'](**params)
    is_output = constant_dict['my_func2::is_output']
    params = params_dict['my_func2']
    input_dict = {}
    input_dict['fwd'] = fwd
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    (output, fwd) = model_dict['my_func14'](**params)
    is_output = constant_dict['my_func14::is_output']
    params = params_dict['my_func14']
    input_dict = {}
    input_dict['fwd'] = fwd
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    (output, fwd) = model_dict['my_func26'](**params)
    is_output = constant_dict['my_func26::is_output']
    params = params_dict['my_func26']
    input_dict = {}
    input_dict['fwd'] = fwd
    ...
    input_dict['fwd'] = fwd
    params.update(input_dict)
    fwd = model_dict['my_func32'](**params)
    output = constant_dict['my_func32::output']
    is_output = constant_dict['my_func32::is_output']
    params = params_dict['my_func32']
    input_dict = {}
