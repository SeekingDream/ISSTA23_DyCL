...
class BasicBlockWOutput(nn.Module):
    ...
    def __init__(self, in_channels, channels, params, stride=1):
        ...
        add_output = params[0]
        self.num_classes = params[1]
        self.input_size = params[2]
        ...
        if add_output:
            self.output = InternalClassifier(self.input_size, self.expansion*channels, self.num_classes)
    ...
    def forward(self, x):
        ...
        return self.layers[2](fwd), torch.tensor(1), self.output(fwd)         # output layers for this module
    ...
    def only_forward(self, x):
        ...
        return self.layers[2](fwd), torch.tensor(0), torch.zeros([len(x), self.num_classes])
...
class ResNet_SDN(nn.Module):
    def __init__(self, params):
        ...
        end_layers.append(nn.Linear(16*64*self.block.expansion, self.num_classes))
