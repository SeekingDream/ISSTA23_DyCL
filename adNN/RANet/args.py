...
exp_group.add_argument('--save', default='cifar10'.format(time.time()),
...
exp_group.add_argument('--evaluate-from', default='cifar10/save_models/model_best.pth.tar', type=str, metavar='PATH',
...
data_group.add_argument('--data-root', metavar='DIR', default='/home/sxc180080/data/Project/Dataset/CIFAR10',
